This project focuses on analyzing accelerometer data from various human activities (walking, running, climbing up/down) using time series visibility graphs. 
